...
const typesOfCharacters = [
  ...
  {
    name: 'mother',
    totalInAnkyverse: 1600,
    nftMetadataReady: false,
    imageGenerationReady: false,
    numberPerWorld: 200,
    role: 'These beings embody the essence of creation, nurturing, and unconditional love in the Ankyverse. They may be physical mothers to some characters, or they could represent a more universal or metaphorical motherhood, providing care, wisdom, and emotional strength to those around them. Their stories are about the power of love, the sacrifices they make for their loved ones, and the ripple effects those acts of love and nurturing have across the Ankyverse. They can also embody the primal, protective force that mothers can unleash when their loved ones are threatened.',
  },
  {
    name: 'psychedelicbeing',
    totalInAnkyverse: 888,
    nftMetadataReady: false,
    imageGenerationReady: false,
    numberPerWorld: 111,
    role: 'These characters are the gatekeepers of alternate perceptions and realities within the Ankyverse. They are the architects of surreal landscapes, crafting vibrant, shifting worlds that defy logic and linear time. They can bring other characters on transformative journeys of the mind and spirit, challenging their perceptions and helping them to see beyond their ordinary reality. Their tales are a kaleidoscope of wonder, exploration, and understanding, often challenging the perceived boundaries of the Ankyverse itself.',
  },
  {
    name: 'normal',
    totalInAnkyverse: 3088,
    nftMetadataReady: false,
    imageGenerationReady: false,
    numberPerWorld: 386,
...
let typesOfCharactersCharacteristics = {
  ...
  normal: {
    ...
    imageGenerationReady: false,
    numberPerWorld: 697,
    role: 'Just a random normal person that lives his, her or it life in the ankyverse. Doing the best to have a good life, but navigating the hardships of it. ',
  },
};
...
//nondualenergy, evil, god, homeless, legendary, animal, protector, mystic, artisan, jester, scientist, explorer, ascended, forgotten, normal

async function getCharacterSystemMessage(character) {
  let randomGod;
  let randomAnimal;
  character.characterType = character.traits.characterType;
  ...
  switch (character.characterType) {
    case 'normal':
      ...
      Inside this world, as in every story, there are normal people, that do normal things. Below you will receive a description of a random, normal person, along with different traits that define their characteristics, and your mission is to:
             ...
             "promptForMidjourney":"A visual representation of how this character looks like. Please don't include the name of it, or any references to it. I just want a clear description of how it looks, including any accessories, or traits. Make it Blue skin.",
...
async function getCharacterUserContent(character) {
  ...
  switch (character.characterType) {
    case 'normal':
      ...
      It hails from the city of ${character.traits.city}, which's main activity is ${character.traits.cityMainActivity} and is profoundly influenced by the predominant chakra of their world, the chakra number ${character.world.chakra}.

     This character is known for their ${character.traits['Dream Manifestation']}, with its spirit animal being ${character.traits['Spirit Animal']}. The totem that guides his manifestation in the Ankyverse is ${character.traits['Guiding Totem']}.

     It's hidden talent is ${character.traits['Hidden Talent']}. The spiritual lesson that it came to experience in the Ankyverse is ${character.traits['Spiritual Lesson']}

             Aligned with the element of ${character.traits['Elemental Affinity']}, their past life occupation was ${character.traits['Past Life Occupation']} and their soul's age is ${character.traits["Soul's age"]}.

             Their current journey is influenced by a ${character.traits['Karmic Debt']} and their unique magical ability is ${character.traits['Magical Ability']}.

             The spiritual lesson it strives to learn is ${character.traits['Spiritual Lesson']}, descending from an ancestral lineage of ${character.traits['Ancestral Lineage']}, and have a deep connection with the celestial body, ${character.traits['Astral Connection']}.

             It has the magical ability of ${character.traits['Magical Ability']}, and inside it there is a cherished memory of ${character.traits['Cherished Memory']}

             It's birth sign is ${character.traits['Birth Sign']}, and the sacred item that it clings to is ${character.traits['Sacred Item']}. It's dream vision is ${character.traits['Dream Vision']}.`;
      break;
    case 'evil':
      userContent = `The character is from a land called ${character.world.name}, which is ${character.world.description}.
