...
async function requestCharacterImage(character, worldId) {
  ...
  try {
    ...
    if (responseFromImagineApi.id) {
      ...
      console.log(
        "The character was updated from GERMINAL to EMBRYONIC. It's id is: ",
        character.id
      );
      setTimeout(
...
async function getImageInformation(character, worldId) {
  ...
  try {
    ...
    if (response.data.data.status === 'completed') {
      ...
      console.log(
        "The character was updated from EMBRYONIC to FETAL. It's id is: ",
        character.id
      );
      ...
      console.log(
        "The character was updated from EMBRYONIC to FAILED. It's id is: ",
        character.id
      );
    }
    setTimeout(() => {
